...
type DecodedVIN struct {
	...
	CombinedBrakingSystem               string `json:"CombinedBrakingSystem"`
	...
	FuelTankMaterial                    string `json:"FuelTankMaterial"`
	FuelTankType                        string `json:"FuelTankType"`
	...
	WheelieMitigation                   string `json:"WheelieMitigation"`
...
type vinResponse struct {
	...
	Results        []DecodedVIN `json:"Results"`
}
